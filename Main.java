...
public class Main {
    ...
    private static void exercise1() {
        ...
        for(Integer index : itemsA)
        {
            sumForA = sumForA + index;
        }

        System.out.println("Sum A: " + sumForA);
        ...
        System.out.println("Sum B: " + sumForB);
        ...
        for(Integer i = 0; i < itemsA.size(); i++)
        {
            sumForC = sumForC + itemsA.get(i);
        }

        System.out.println("Sum C: " + sumForC);
    ...
    private static void exercise5() {
        ...
        for (int timesTableNumber = 1; timesTableNumber <= 10; timesTableNumber++)
        {
            ...
            for (int j = 1; j <= 10; j++ )
            {
                value = timesTableNumber * j;
                System.out.println(timesTableNumber + " x " + j + " = " + value);
            }
